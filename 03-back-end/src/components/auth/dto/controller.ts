...
import { IUserLogin, IUserLoginValidator } from './IUserLogin';
import * as bcrypt from 'bcrypt';
import ITokenData from './ITokenData.interface';
import * as jwt from "jsonwebtoken";
import Config from '../../../config/dev';
import { IAdministratorLogin, IAdministratorLoginValidator } from './IAdministratorLogin';
